...
1. **[TUTORIAL.md](TUTORIAL.md)** - 5-minute mastery guide (read this first!)
2. **`./QUICKSTART.sh`** - One-command setup
...
1. Create a new shell script in `hooks/` directory
2. Add it to `hooks.json` with the appropriate event
